...
<script lang="ts">
  ...
  $: temFiltrosAtivos = busca || categoria || material || preco_min || preco_max;
  ...
  function getMaterialColor(material: string): string {
    switch (material?.toLowerCase()) {
      ...
      case 'trivex': return 'warning';
      case 'polycarbonate': return 'primary';
      default: return 'primary';
    }
  }
...
<svelte:head>
  ...
  <meta name="description" content="Catálogo completo de lentes oftálmicas com filtros avançados e comparação de fornecedores" />
</svelte:head>
    ...
    <Container maxWidth="xl" padding="md">
      ...
      <section class="mt-12">
        <div class="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm">
          <SectionHeader title="Buscar no Catálogo" subtitle="Use os filtros para encontrar a lente ideal" />
