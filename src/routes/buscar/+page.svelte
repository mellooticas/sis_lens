...
<svelte:head>
  ...
  <meta name="description" content="Busque lentes oftálmicas com filtros avançados e compare fornecedores" />
</svelte:head>
    ...
    <Container maxWidth="xl" padding="md">
      ...
      <section class="mt-12">
        <div class="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm">
          <SectionHeader title="Buscar Lentes" subtitle="Digite o nome, família ou SKU da lente" />
