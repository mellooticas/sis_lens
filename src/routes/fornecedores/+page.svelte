<script lang="ts">
  ...
  const tableHeaders = [
    ...
    { key: 'preco_competitivo', label: 'Competitividade', align: 'center' as const },
...
<svelte:head>
  ...
  <meta name="description" content="Gestão e acompanhamento de fornecedores/laboratórios" />
</svelte:head>
    ...
    <Container maxWidth="xl" padding="md">
      ...
      <section class="mt-12">
        <SectionHeader
          ...
          subtitle={fornecedoresFiltrados.length ? `${fornecedoresFiltrados.length} fornecedores encontrados` : ''}
...
{#if showNewModal}
  <div class="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <!-- Modal -->
    <div class="relative bg-white dark:bg-neutral-800 rounded-xl max-w-md w-full mx-4 p-6">
      <div class="text-center">
        ...
        <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-6">
          Para cadastrar um novo fornecedor, acesse a página de administração ou entre em contato com nosso suporte.
        </p>
