...
<svelte:head>
  ...
  <meta name="description" content="Painel principal do sistema decisor de lentes BestLens" />
</svelte:head>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            {#each Object.entries(disponibilidade) as [status, count]}
              <StatsCard
                ...
                icon={status === 'disponivel' ? '✅' : status === 'limitado' ? '⚠️' : '❌'}
            ...
            <div class="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm">
              ...
              {#if decisoesRecentes.length > 0}
                  ...
                  >
                    <svelte:fragment slot="cell" let:row let:column>
                      ...
                      {:else if column === 'marca'}
                        <Badge variant={getMarcaColor(row.lentes_catalogo?.marca_nome)} size="sm">
                      ...
                      {:else if column === 'confianca'}
                        <span class="font-medium text-blue-600 dark:text-blue-400 text-sm">
                ...
                <div class="mt-4 text-center">
                  <Button variant="ghost" size="sm" on:click={() => irPara('/historico')}>
          ...
          <section>
            <div class="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm">
              ...
              {#if topMarcas.length > 0}
                  ...
                  {#each topMarcas as marca, index}
                    <div class="flex items-center justify-between p-3 bg-neutral-50 dark:bg-neutral-900 rounded-lg">
                      <div class="flex items-center gap-3">
                        <span class="text-sm font-bold text-neutral-500 dark:text-neutral-400 w-6">
                          #{index + 1}
                        </span>
                ...
                <div class="mt-4 text-center">
                  <Button variant="ghost" size="sm" on:click={() => irPara('/analytics')}>
          ...
          <section>
            <div class="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm">
              ...
              {#if topLentes.length > 0}
                ...
                <div class="mt-4 text-center">
                  <Button variant="ghost" size="sm" on:click={() => irPara('/ranking')}>
                    ...
                    <div class="p-4 border border-neutral-200 dark:border-neutral-700 rounded-lg">
                      <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 space-y-1">
                          <h4 class="font-medium text-neutral-900 dark:text-neutral-100 text-sm">
                            {alerta.titulo}
                          </h4>
