            ...
            <div class="py-6">
                <div class="flex items-start justify-between gap-4 flex-wrap">
                    <div>
                        ...
                        <h1 class="text-2xl font-black text-neutral-900 dark:text-white">Standard Collection</h1>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" bind:value={busca}
                                ...
                                class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg px-3 py-2 text-neutral-700 dark:text-neutral-300 focus:outline-none focus:ring-2 focus:ring-sky-400"/>
                        </div>
                        <div>
                            ...
                            <select bind:value={lens_type}
                                class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg px-3 py-2 text-neutral-700 dark:text-neutral-300 focus:outline-none focus:ring-2 focus:ring-sky-400 cursor-pointer">
        ...
        <div class="mt-6">
            {#if loading}
                <div class="flex flex-col items-center justify-center py-24 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-2xl">
                    ...
                    <p class="text-neutral-500 dark:text-neutral-400 text-sm">Carregando catálogo standard...</p>
                </div>
            ...
            {:else if canonicais.length === 0}
                <div class="py-24 text-center">
                    ...
                    <p class="text-neutral-500 dark:text-neutral-400 text-lg font-semibold">Nenhum conceito encontrado</p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    {#each canonicais as c (c.id)}
                        <a href="/standard/{c.id}"
                            class="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-2xl p-5 hover:shadow-md hover:border-sky-200 dark:hover:border-sky-800 transition-all duration-200 flex flex-col gap-3 no-underline">
                                ...
                                {#each Array.from({ length: total_paginas }, (_, i) => i + 1) as p}
                                    {#if p === 1 || p === total_paginas || (p >= data.pagina - 2 && p <= data.pagina + 2)}
                                        <button type="button" on:click={() => irParaPagina(p)}
                                            class="w-9 h-9 text-sm font-bold rounded-lg transition-colors {p === data.pagina ? 'bg-sky-600 text-white shadow-sm' : 'bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800'}">
                                            {p}
                                        </button>
