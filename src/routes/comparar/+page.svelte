...
<svelte:head>
  ...
  <meta name="description" content="Compare especificações e preços de lentes lado a lado" />
</svelte:head>
  ...
  <main>
    <Container maxWidth="xl" padding="md">
        ...
        <div class="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm">
          <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
              ...
              <Button variant="primary" size="sm" disabled={totalSelecionadas === 0}>
                📊 Gerar Relatório
              </Button>
            </div>
          </div>
      ...
      {#if lentesComparacao.length > 0}
        <section class="mt-12">
          <SectionHeader title="Comparação Detalhada" subtitle="Especificações lado a lado" />
            ...
            <div class="overflow-x-auto">
              <table class="w-full">
                <thead class="bg-neutral-50 dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-700">
                  <tr>
                    <th class="px-6 py-4 text-left text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                      Especificação
                    </th>
                    {#each lentesComparacao as lente, index}
                      <th class="px-6 py-4 text-center text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                        <div class="space-y-2">
                ...
                <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                  ...
                  <tr>
                    ...
                    {#each lentesComparacao as lente}
                      <td class="px-6 py-4 text-center font-medium text-purple-600 dark:text-purple-400">
        ...
        <section class="mt-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            {#each lentesSugeridas.slice(0, 9) as lente}
              <div class="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-4 hover:shadow-md transition-shadow">
                <div class="space-y-3">
                  <div>
